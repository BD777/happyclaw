...
- Preserve the Mac mini's runtime data and configuration, follow the documented deployment procedure, and report separately on local verification and Mac mini verification.
